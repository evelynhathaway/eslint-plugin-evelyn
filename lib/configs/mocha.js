	...
	"node",
	{
		...
		"rules": {
			...
			*/
			...
			"node/no-unsupported-features/es-builtins": "warn", // Allow for unsupported features
			"node/no-unsupported-features/es-syntax": "warn", // Allow for unsupported features
			/*
				Mocha rules
